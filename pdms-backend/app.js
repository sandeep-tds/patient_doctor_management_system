...
/**
 * Checks if Patients table exists. If it doesn't, it creates a new patients table.
 * This method is invoked each time we deploy our code (cf push)
 * @param  {} function(result
 * @param  {} error
 */
dbInterface.createPatientsTable(function(result, error){
  if (error) {
    console.log("Could not create patients table");
  } else {
    console.log("Patients Table either already exists or a new table has been created");
  }
});
